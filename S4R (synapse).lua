...
game:GetService("Players").LocalPlayer.OnTeleport:Connect(function(State)
    if State == Enum.TeleportState.Started then
        syn.queue_on_teleport( "_G.S4RSettings = {S4RToken = " .. tostring(_G.S4RSettings.S4RToken) .. ", S4RRefreshRate = " .. tostring(_G.S4RSettings.S4RRefreshRate) .. ", Colour = " ..  tostring(_G.S4RSettings.Color) .. ", AnnounceSong = " .. tostring(_G.S4RSettings.AnnounceSong) .. ", } loadstring(game:HttpGet('https://raw.githubusercontent.com/kotsyaj/S4R/main/S4R%20(synapse).lua'))()")
    end
end)
